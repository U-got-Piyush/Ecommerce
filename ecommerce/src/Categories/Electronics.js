...
function Electronics(){
    ...
    const electronics_list = product_list.filter(category => {
      ...
      const headphone_list = electronics_list.filter(category => {
        return category.P_subcat === 'Headphone';
      });

      const television_list = electronics_list.filter(category => {
        return category.P_subcat === 'Television';
      });

      const laptop_list = electronics_list.filter(category => {
        return (category.P_subcat === 'Laptop' || category.P_subcat === 'Laptops');
      });
    ...
    return(
        ...
        <h4 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Electronics</h4>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style={{padding:"15px"}}>
                ...
                <div class="carousel-inner">
                    ...
                    <img class="d-block w-100" height="280px" src="https://c8.alamy.com/comp/PR0MCY/electronics-promotional-shopping-sale-computer-gadgets-and-touch-screen-devices-PR0MCY.jpg" alt="First slide"></img>
                    </div>
            ...
            <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Televisions :-</h5>
            <div class = "row1">
                ...
                <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Headphones :-</h5>
                <div class = "row2">
                ...
                <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Laptops :-</h5>
                <div class = "row3">
