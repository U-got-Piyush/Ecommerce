...
function Vehicles(){
    ...
    const vehicle_list = product_list.filter(category => {
        return category.P_cat === '2Wheelers';
      });

      const scooter_list = vehicle_list.filter(category => {
        return category.P_subcat === 'Scooter';
      });
    ...
    return(
        ...
        <div class = "vehicles" style={{backgroundColor:"#F1F3F6"}}>

        <h4 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>2 Wheelers</h4>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style={{padding:"15px"}}>
                ...
                <div class="carousel-inner">
                    ...
                    <img class="d-block w-100" height="280px" src="https://i.pinimg.com/originals/6e/ba/8a/6eba8a34c54dd13337f0bff600ce2553.jpg" alt="First slide"></img>
                    </div>
            ...
            <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Electric Scooter's :-</h5>
            <div class = "row1">
