...
function Appliances(){
    ...
    const appliances_list = product_list.filter(category => {
        return category.P_cat === 'Appliances';
      });

      const wash_list = appliances_list.filter(category => {
        return category.P_subcat === 'Washing machine';
      });

      const ac_list = appliances_list.filter(category => {
        return category.P_subcat === 'Air Conditioner';
      });
    ...
    return(
        ...
        <div class = "appliances" style={{backgroundColor:"#F1F3F6"}}>

        <h4 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Appliances</h4>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style={{padding:"15px"}}>
                ...
                <div class="carousel-inner">
                    ...
                    <img class="d-block w-100" height="280px" src="https://www.shutterstock.com/image-vector/vector-set-home-appliances-collection-260nw-1959547759.jpg" alt="First slide"></img>
                    </div>
            ...
            <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Air Conditioners :-</h5>
            <div class = "row1">
                ...
                <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Washing Machines :-</h5>
                <div class = "row2">
