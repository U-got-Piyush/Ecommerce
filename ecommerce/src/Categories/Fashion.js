...
function Fashion(){
    ...
    const fashion_list = product_list.filter(category => {
      ...
      const women_list = fashion_list.filter(category => {
        return (category.P_subcat === 'Ethnic Wear Women' || category.P_subcat === 'Western Wear Women');
      });

      const men_list = fashion_list.filter(category => {
        return (category.P_subcat === 'Ethnic Wear Men' || category.P_subcat === 'Western Wear Men');
      });
    ...
    return(
        ...
        <div class = "fashion" style={{backgroundColor:"#F1F3F6"}}>

        <h4 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Fashion</h4>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style={{padding:"15px"}}>
                ...
                <div class="carousel-inner">
                    ...
                    <img class="d-block w-100" height="280px" src="https://i.pinimg.com/originals/fa/b9/ec/fab9ecd3d3b39a7ee39ef3e87e083713.png" alt="First slide"></img>
                    </div>
            ...
            <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Women :-</h5>
            <div class = "row1">
                ...
                <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Men :-</h5>
                <div class = "row2">
