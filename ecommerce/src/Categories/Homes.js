...
function Homes(){
    ...
    const homes_list = product_list.filter(category => {
        return category.P_cat === 'Home';
      });

      const cook_list = homes_list.filter(category => {
        return category.P_subcat === 'Cookware';
      });

      const decoration_list = homes_list.filter(category => {
        return category.P_subcat === 'Decoration';
      });
    ...
    return(
        ...
        <h4 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Home</h4>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style={{padding:"15px"}}>
                ...
                <div class="carousel-inner">
                    ...
                    <img class="d-block w-100" height="280px" src="https://social.manorhouse.in/images/home_banner.jpg?version=2.2.15&subv=1.8" alt="First slide"></img>
                    </div>
            ...
            <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Cookware :-</h5>
            <div class = "row1">
                ...
                <h5 style={{marginLeft:"15px" , paddingTop:"10px", paddingBottom:"0px",marginBottom:"0px"}}>Home Decoration :-</h5>
                <div class = "row2">
