...
function Bottom(){
    return(
        ...
        <div class = "bottom" style={{backgroundColor:"#172337"}}>

            <div class = "ul-list">
                <ul>
                    <li style={{paddingBottom:"10px", color:"gray"}}>About</li>
                ...
                <ul>
                    <li style={{paddingBottom:"10px", color:"gray"}}>Help</li>
                ...
                <ul>
                    <li style={{paddingBottom:"10px", color:"gray"}}>Policy</li>
                ...
                <ul>
                    <li style={{paddingBottom:"10px", color:"gray"}}>Social</li>
